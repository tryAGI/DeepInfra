...
internal static partial class DedicatedModelsDeployCreateHfCommandApiCommand
{
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::DeepInfra.HFModel>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DedicatedModels.DeployCreateHfAsync(
                                    xiApiKey: xiApiKey,
                                    xApiKey: xApiKey,
                                    modelName: modelName,
                                    task: task,
