...
internal static partial class SandboxesGetSandboxCommandApiCommand
{
        ...
        name: @"--x-api-key")
    {
        Description = @"",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::DeepInfra.SandboxOut value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::DeepInfra.SandboxOut value, ref string? text);
