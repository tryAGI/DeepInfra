...
internal static partial class ImageGenerationOpenaiImagesEditsCommandApiCommand
{
    ...
    private static Option<global::DeepInfra.OpenAIImagesEditsIn?> Inp { get; } = new(
        name: @"--inp")
    {
        Description = @"",
    };
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ImageGeneration.OpenaiImagesEditsAsync(
                                    xiApiKey: xiApiKey,
                                    xApiKey: xApiKey,
                                    image: image,
                                    imagename: imagename,
