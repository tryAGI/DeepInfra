...
internal static partial class DedicatedModelsDeployGpuAvailabilityCommandApiCommand
{
    ...
    {
        var command = new Command(@"deploy-gpu-availability", @"Deploy Gpu Availability");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DedicatedModels.DeployGpuAvailabilityAsync(
                                    source: source,
                                    baseModel: baseModel,
                                    xiApiKey: xiApiKey,
                                    xApiKey: xApiKey,
