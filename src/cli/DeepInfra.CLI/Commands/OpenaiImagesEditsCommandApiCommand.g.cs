...
internal static partial class OpenaiImagesEditsCommandApiCommand
{
...
Edit image using OpenAI Images Edits API");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::DeepInfra.BodyOpenaiImagesEditsV1ImagesEditsPost>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.OpenaiImagesEditsAsync(
                                    xiApiKey: xiApiKey,
                                    image: image,
                                    imagename: imagename,
                                    prompt: prompt,
