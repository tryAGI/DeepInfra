...
internal static partial class AudioOpenaiAudioTranscriptionsCommandApiCommand
{
    ...
    private static Option<global::DeepInfra.BodyOpenaiAudioTranscriptionsV1AudioTranscriptionsPostResponseFormat?> ResponseFormat { get; } = new(
    ...
    private static Option<string?> ServiceTier { get; } = new(
        name: @"--service-tier")
    {
        Description = @"",
    };
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Audio.OpenaiAudioTranscriptionsAsync(
