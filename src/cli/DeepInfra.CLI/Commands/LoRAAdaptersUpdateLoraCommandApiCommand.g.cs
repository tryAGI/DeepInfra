...
internal static partial class LoRAAdaptersUpdateLoraCommandApiCommand
{
    ...
    private static Option<bool?> Private { get; } = CliRuntime.CreateNullableBoolOption(
        name: @"--private",
        description: @"");
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::DeepInfra.UpdateLoraApiRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                        ...
                        var @private = CliRuntime.WasSpecified(parseResult, Private) ? parseResult.GetValue(Private) : (__requestBase is { } __PrivateBaseValue ? __PrivateBaseValue.Private : default);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LoRAAdapters.UpdateLoraAsync(
                                    loraName: loraName,
                                    xiApiKey: xiApiKey,
                                    xApiKey: xApiKey,
                                    @private: @private,
