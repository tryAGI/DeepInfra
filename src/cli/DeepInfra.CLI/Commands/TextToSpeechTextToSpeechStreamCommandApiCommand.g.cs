...
internal static partial class TextToSpeechTextToSpeechStreamCommandApiCommand
{
    ...
    public static Command Create()
    {
        var command = new Command(@"stream", @"Text To Speech Stream");
                        ...
                        command.Options.Add(XApiKey);                        command.Options.Add(ElevenLabsTextToSpeechInOptionSetOptions.Text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var xApiKey = parseResult.GetValue(XApiKey);                        var text = parseResult.GetRequiredValue(ElevenLabsTextToSpeechInOptionSetOptions.Text);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.TextToSpeech.TextToSpeechStreamAsync(
                                    voiceId: voiceId,
