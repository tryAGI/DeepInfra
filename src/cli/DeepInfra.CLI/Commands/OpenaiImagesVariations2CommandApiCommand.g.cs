...
internal static partial class OpenaiImagesVariations2CommandApiCommand
{
    ...
    {
        var command = new Command(@"openai-images-variations2", @"Openai Images Variations
Generate a similar image using OpenAI Images Variations API");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::DeepInfra.BodyOpenaiImagesVariationsV1OpenaiImagesVariationsPost>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.OpenaiImagesVariations2Async(
                                    xiApiKey: xiApiKey,
                                    image: image,
                                    imagename: imagename,
                                    model: model,
