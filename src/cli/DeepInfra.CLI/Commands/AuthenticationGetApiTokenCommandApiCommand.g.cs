...
internal static partial class AuthenticationGetApiTokenCommandApiCommand
{
    ...
    {
        var command = new Command(@"get-api-token", @"Get Api Token");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Authentication.GetApiTokenAsync(
                                    apiToken: apiToken,
                                    xiApiKey: xiApiKey,
                                    xApiKey: xApiKey,
