...
internal static partial class DedicatedModelsDeployDetailedStatsCommandApiCommand
{
        ...
        name: @"--x-api-key")
    {
        Description = @"",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::DeepInfra.DetailedDeploymentStatsOut value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::DeepInfra.DetailedDeploymentStatsOut value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DedicatedModels.DeployDetailedStatsAsync(
                                    deployId: deployId,
                                    from: from,
                                    to: to,
                                    xiApiKey: xiApiKey,
