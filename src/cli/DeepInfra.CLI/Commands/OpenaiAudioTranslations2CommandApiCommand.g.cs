...
internal static partial class OpenaiAudioTranslations2CommandApiCommand
{
    ...
    private static Option<global::DeepInfra.BodyOpenaiAudioTranslationsV1OpenaiAudioTranslationsPostResponseFormat2?> ResponseFormat { get; } = new(
    ...
    {
        var command = new Command(@"openai-audio-translations2", @"Openai Audio Translations");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::DeepInfra.BodyOpenaiAudioTranslationsV1OpenaiAudioTranslationsPost>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.OpenaiAudioTranslations2Async(
