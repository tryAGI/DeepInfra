...
internal static partial class ChatCompletionsOpenaiChatCompletionsCommandApiCommand
{
    ...
    private static Option<global::System.Collections.Generic.IList<global::DeepInfra.OneOf<global::DeepInfra.ChatCompletionToolMessage, global::DeepInfra.ChatCompletionAssistantMessage, global::DeepInfra.ChatCompletionUserMessage, global::DeepInfra.ChatCompletionSystemMessage>>> Messages { get; } = new(
        name: @"--messages")
    {
...
The total length of input tokens and generated tokens is limited by the model's context length. If explicitly set to None it will be the model's max context length minus input length or 65536, whichever is smaller.",
    ...
    private static Option<global::System.Collections.Generic.IList<global::DeepInfra.FunctionTool>?> Tools { get; } = new(
        name: @"--tools")
    {
    ...
    private static Option<global::DeepInfra.ChatReasoningSettings?> Reasoning { get; } = new(
        name: @"--reasoning")
    {
