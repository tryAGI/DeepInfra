...
internal static partial class InferenceInferenceDeployCommandApiCommand
{
    ...
    {
        var command = new Command(@"deploy", @"Inference Deploy");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Inference.InferenceDeployAsync(
                                    deployId: deployId,
                                    xiApiKey: xiApiKey,
                                    xApiKey: xApiKey,
