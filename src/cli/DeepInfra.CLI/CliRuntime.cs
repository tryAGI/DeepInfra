...
{
    private const string UserSecretsId = "DeepInfra.CLI";
    private const string UserSecretApiKeyName = "DEEPINFRA_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"DEEPINFRA_API_KEY"];
    private const string CredentialFileDirectoryName = ".deep-infra";

    public static async global::System.Threading.Tasks.Task<global::DeepInfra.DeepInfraClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::DeepInfra.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::DeepInfra.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::DeepInfra.DeepInfraClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::DeepInfra.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::DeepInfra.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::DeepInfra.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::DeepInfra.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("DEEPINFRA_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::DeepInfra.ApiException exception)
    {
        var builder = new StringBuilder();
