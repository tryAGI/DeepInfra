...
namespace DeepInfra
{
    public partial interface IAuthenticationClient
    {
        ...
        global::System.Threading.Tasks.Task<string> GoogleLoginAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> GoogleLoginAsResponseAsync(
            string? loginId = default,
            string? origin = default,
            string? deal = default,
            string? tiToken = default,
