...
namespace DeepInfra
{
    public partial class DedicatedModelsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_DeploymentStatsSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_DeploymentStatsSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_DeploymentStatsSecurityRequirement0,
            };
        partial void PrepareDeploymentStatsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string from,
            ref string? to,
            ref string? xiApiKey);
        partial void PrepareDeploymentStatsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string from,
            string? to,
            string? xiApiKey);
        partial void ProcessDeploymentStatsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeploymentStatsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::DeepInfra.DeploymentMainStatsOut>> DeploymentStatsAsync(
            string from,
            string? to = default,
        ...
        {
            var __response = await DeploymentStatsAsResponseAsync(
                from: from,
                to: to,
                xiApiKey: xiApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::DeepInfra.DeploymentMainStatsOut>>> DeploymentStatsAsResponseAsync(
            string from,
            string? to = default,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeploymentStatsArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeploymentStatsSecurityRequirements,
                operationName: "DeploymentStatsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeploymentStatsAsync",
                                pathTemplate: "\"/deploy/stats\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeploymentStatsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeploymentStatsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::DeepInfra.DeploymentMainStatsOut>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::DeepInfra.DeploymentMainStatsOut>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::DeepInfra.DeploymentMainStatsOut>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::DeepInfra.DeploymentMainStatsOut>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::DeepInfra.DeploymentMainStatsOut>), JsonSerializerContext).ConfigureAwait(false) ??
