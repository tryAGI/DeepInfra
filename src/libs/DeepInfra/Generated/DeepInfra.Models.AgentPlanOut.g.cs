...
namespace DeepInfra
{
    ...
    public sealed partial class AgentPlanOut
    {
        ...
        /// <summary>
        /// Included monthly egress allowance in GB
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("monthly_egress_gb")]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required int MonthlyEgressGb { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentPlanOut" /> class.
        /// </summary>
        /// <param name="id">
        /// Plan identifier
        /// </param>
            ...
            int monthlyEgressGb)
        {
            ...
            this.MonthlyEgressGb = monthlyEgressGb;
        }
