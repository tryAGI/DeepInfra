...
namespace DeepInfra
{
    ...
    /// </summary>
    public sealed partial class DeepInfraClient : global::DeepInfra.IDeepInfraClient, global::System.IDisposable
    {
        /// <summary>
        ///
        /// </summary>
        public const string DefaultBaseUrl = "https://api.deepinfra.com/";
        ...
        internal global::System.Lazy<global::System.Text.Json.Serialization.JsonSerializerContext> JsonSerializerContextProvider { get; set; } = new(() => global::DeepInfra.SourceGenerationContext.Default);
        ...
        /// <summary>
        /// Manage agent-framework instances (OpenClaw and friends).
        /// </summary>
        ...
        /// </summary>
        public FilesBatchesClient FilesBatches => new FilesBatchesClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContextProvider = JsonSerializerContextProvider,
        };
        ...
        /// </summary>
        public GpuRentalsClient GpuRentals => new GpuRentalsClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContextProvider = JsonSerializerContextProvider,
        };
        ...
        /// </summary>
        public LoRAAdaptersClient LoRAAdapters => new LoRAAdaptersClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContextProvider = JsonSerializerContextProvider,
        };
        ...
        /// </summary>
        public LogsMetricsClient LogsMetrics => new LogsMetricsClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContextProvider = JsonSerializerContextProvider,
        };
        ...
        ///
        /// </summary>
        public TokenizerClient Tokenizer => new TokenizerClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContextProvider = JsonSerializerContextProvider,
        };
        ...
        /// <summary>
        /// Creates a new instance of the DeepInfraClient with explicit options but no base URL override.
