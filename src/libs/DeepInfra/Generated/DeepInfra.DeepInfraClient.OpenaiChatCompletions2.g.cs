...
namespace DeepInfra
{
    ...
    {
        partial void PrepareOpenaiChatCompletions2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xDeepinfraSource,
            ref string? userAgent,
            ref string? xiApiKey,
            global::DeepInfra.OpenAIChatCompletionsIn request);
        partial void PrepareOpenaiChatCompletions2Request(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xiApiKey,
            global::DeepInfra.OpenAIChatCompletionsIn request);
        partial void ProcessOpenaiChatCompletions2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenaiChatCompletions2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOpenaiChatCompletions2Arguments(
            ...
            PrepareOpenaiChatCompletions2Request(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessOpenaiChatCompletions2Response(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessOpenaiChatCompletions2ResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
