...
namespace DeepInfra
{
    public partial class DedicatedModelsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_DeployArgsRestoreSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_DeployArgsRestoreSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_DeployArgsRestoreSecurityRequirement0,
            };
        partial void PrepareDeployArgsRestoreArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string deployId,
            ref string entryId,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareDeployArgsRestoreRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessDeployArgsRestoreResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeployArgsRestoreResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.DeployStatusOut> DeployArgsRestoreAsync(
            string deployId,
            string entryId,
        ...
        {
            var __response = await DeployArgsRestoreAsResponseAsync(
                deployId: deployId,
                entryId: entryId,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.DeployStatusOut>> DeployArgsRestoreAsResponseAsync(
            string deployId,
            string entryId,
            string? xiApiKey = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeployArgsRestoreArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeployArgsRestoreSecurityRequirements,
                operationName: "DeployArgsRestoreAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/deploy/{deployId}/config/history/{entryId}/restore",
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeployArgsRestoreRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeployArgsRestore",
                                methodName: "DeployArgsRestoreAsync",
                                pathTemplate: "$\"/deploy/{deployId}/config/history/{entryId}/restore\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeployArgsRestoreResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeployArgsRestoreResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.DeployStatusOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.DeployStatusOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.DeployStatusOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
