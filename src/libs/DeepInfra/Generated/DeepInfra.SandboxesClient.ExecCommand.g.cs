...
namespace DeepInfra
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_ExecCommandSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_ExecCommandSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_ExecCommandSecurityRequirement0,
            };
        partial void PrepareExecCommandArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            ref string? xiApiKey,
            ref string? xApiKey,
            global::DeepInfra.SandboxExecIn request);
        partial void PrepareExecCommandRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xApiKey,
            global::DeepInfra.SandboxExecIn request);
        partial void ProcessExecCommandResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExecCommandResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ExecCommandAsync(
            string sandboxId,
        ...
        {
            var __response = await ExecCommandAsResponseAsync(
                sandboxId: sandboxId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> ExecCommandAsResponseAsync(
            string sandboxId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExecCommandSecurityRequirements,
                operationName: "ExecCommandAsync");
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExecCommandResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> ExecCommandAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepInfra.SandboxExecIn
            {
                Command = command,
