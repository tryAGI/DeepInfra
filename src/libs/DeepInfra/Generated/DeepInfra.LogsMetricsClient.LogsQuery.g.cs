...
namespace DeepInfra
{
    public partial class LogsMetricsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_LogsQuerySecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_LogsQuerySecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_LogsQuerySecurityRequirement0,
            };
        ...
        {
            var __response = await LogsQueryAsResponseAsync(
                deployId: deployId,
                from: from,
                to: to,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.LogQueryOut>> LogsQueryAsResponseAsync(
            string deployId,
            string? from = default,
            string? to = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_LogsQuerySecurityRequirements,
                operationName: "LogsQueryAsync");
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.LogQueryOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.LogQueryOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.LogQueryOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
