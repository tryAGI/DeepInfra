...
namespace DeepInfra
{
    public partial class AuthenticationClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_OktaLoginSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_OktaLoginSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_OktaLoginSecurityRequirement0,
            };
        partial void PrepareOktaLoginArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string teamId,
            ref string? origin,
            ref string? loginId);
        partial void PrepareOktaLoginRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string teamId,
            string? origin,
            string? loginId);
        partial void ProcessOktaLoginResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOktaLoginResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> OktaLoginAsync(
            string teamId,
        ...
        {
            var __response = await OktaLoginAsResponseAsync(
                teamId: teamId,
                origin: origin,
                loginId: loginId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> OktaLoginAsResponseAsync(
            string teamId,
            string? origin = default,
            string? loginId = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OktaLoginSecurityRequirements,
                operationName: "OktaLoginAsync");
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOktaLoginResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
