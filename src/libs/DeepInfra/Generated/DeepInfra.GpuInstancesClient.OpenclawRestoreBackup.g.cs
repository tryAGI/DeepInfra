...
namespace DeepInfra
{
    public partial class GpuInstancesClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_OpenclawRestoreBackupSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_OpenclawRestoreBackupSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_OpenclawRestoreBackupSecurityRequirement0,
            };
        partial void PrepareOpenclawRestoreBackupArguments(
            ...
            ref string backupId,
            ref string? xiApiKey);
        partial void PrepareOpenclawRestoreBackupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string instanceId,
            string backupId,
            string? xiApiKey);
        partial void ProcessOpenclawRestoreBackupResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenclawRestoreBackupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> OpenclawRestoreBackupAsync(
            string instanceId,
            string backupId,
        ...
        {
            var __response = await OpenclawRestoreBackupAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> OpenclawRestoreBackupAsResponseAsync(
            string instanceId,
            string backupId,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOpenclawRestoreBackupArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OpenclawRestoreBackupSecurityRequirements,
                operationName: "OpenclawRestoreBackupAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/v1/openclaw/{instanceId}/backups/{backupId}/restore",
            ...
            if (xiApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOpenclawRestoreBackupRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OpenclawRestoreBackup",
                                methodName: "OpenclawRestoreBackupAsync",
                                pathTemplate: "$\"/v1/openclaw/{instanceId}/backups/{backupId}/restore\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOpenclawRestoreBackupResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOpenclawRestoreBackupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
