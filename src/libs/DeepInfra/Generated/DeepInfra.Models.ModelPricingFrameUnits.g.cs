...
namespace DeepInfra
{
    ...
    public sealed partial class ModelPricingFrameUnits
    {
        ...
        ///
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("cents_per_frame_unit")]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required double CentsPerFrameUnit { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelPricingFrameUnits" /> class.
        /// </summary>
        /// <param name="centsPerFrameUnit"></param>
        /// <param name="discount">
        /// Promotional discount; you are charged price * (1 - discount)
        /// </param>
...
#endif
        public ModelPricingFrameUnits(
            double centsPerFrameUnit,
            double? discount,
            int? discountEndsAt,
            string? @short,
            string? full,
            ...
            string? type)
        {
            ...
            this.Table = table;
            this.Type = type;
            this.CentsPerFrameUnit = centsPerFrameUnit;
        }
