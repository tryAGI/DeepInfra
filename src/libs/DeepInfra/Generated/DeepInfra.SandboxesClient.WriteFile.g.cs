...
namespace DeepInfra
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_WriteFileSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_WriteFileSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_WriteFileSecurityRequirement0,
            };
        partial void PrepareWriteFileArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            ref string path,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareWriteFileRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessWriteFileResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWriteFileResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> WriteFileAsync(
            string sandboxId,
            string path,
        ...
        {
            var __response = await WriteFileAsResponseAsync(
                sandboxId: sandboxId,
                path: path,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> WriteFileAsResponseAsync(
            string sandboxId,
            string path,
            string? xiApiKey = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WriteFileSecurityRequirements,
                operationName: "WriteFileAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/v1/sandboxes/{sandboxId}/fs/content",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "WriteFileAsync",
                                pathTemplate: "$\"/v1/sandboxes/{sandboxId}/fs/content\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 413)
                            {
                                ...
                                global::DeepInfra.DeepError? __value_413 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_413 = global::DeepInfra.DeepError.FromJson(__content_413, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWriteFileResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
