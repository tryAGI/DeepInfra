...
namespace DeepInfra
{
    public partial class GpuInstancesClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_OpenclawExpandStorageSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_OpenclawExpandStorageSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_OpenclawExpandStorageSecurityRequirement0,
            };
        partial void PrepareOpenclawExpandStorageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string instanceId,
            ref string? xiApiKey,
            global::DeepInfra.OpenClawExpandStorageIn request);
        partial void PrepareOpenclawExpandStorageRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string instanceId,
            string? xiApiKey,
            global::DeepInfra.OpenClawExpandStorageIn request);
        partial void ProcessOpenclawExpandStorageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenclawExpandStorageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> OpenclawExpandStorageAsync(
            string instanceId,
        ...
        {
            var __response = await OpenclawExpandStorageAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> OpenclawExpandStorageAsResponseAsync(
            string instanceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOpenclawExpandStorageArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OpenclawExpandStorageSecurityRequirements,
                operationName: "OpenclawExpandStorageAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/v1/openclaw/{instanceId}/expand_storage",
            ...
            if (xiApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOpenclawExpandStorageRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OpenclawExpandStorage",
                                methodName: "OpenclawExpandStorageAsync",
                                pathTemplate: "$\"/v1/openclaw/{instanceId}/expand_storage\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOpenclawExpandStorageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOpenclawExpandStorageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> OpenclawExpandStorageAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepInfra.OpenClawExpandStorageIn
            {
                NewSizeGb = newSizeGb,
            };

            return await OpenclawExpandStorageAsync(
                instanceId: instanceId,
                xiApiKey: xiApiKey,
                request: __request,
                requestOptions: requestOptions,
