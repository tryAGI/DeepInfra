...
namespace DeepInfra
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_RenameInstanceSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_RenameInstanceSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_RenameInstanceSecurityRequirement0,
            };
        partial void PrepareRenameInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string instanceId,
            ref string? xiApiKey,
            ref string? xApiKey,
            global::DeepInfra.AgentUpdateIn request);
        partial void PrepareRenameInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xApiKey,
            global::DeepInfra.AgentUpdateIn request);
        partial void ProcessRenameInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRenameInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> RenameInstanceAsync(
            string instanceId,
        ...
        {
            var __response = await RenameInstanceAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> RenameInstanceAsResponseAsync(
            string instanceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRenameInstanceArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RenameInstanceSecurityRequirements,
                operationName: "RenameInstanceAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RenameInstanceAsync",
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRenameInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> RenameInstanceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepInfra.AgentUpdateIn
            {
                Name = name,
            };

            return await RenameInstanceAsync(
                instanceId: instanceId,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
                request: __request,
