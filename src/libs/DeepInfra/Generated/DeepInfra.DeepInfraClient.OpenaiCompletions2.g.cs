...
namespace DeepInfra
{
    ...
    {
        partial void PrepareOpenaiCompletions2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xDeepinfraSource,
            ref string? userAgent,
            ref string? xiApiKey,
            global::DeepInfra.OpenAICompletionsIn request);
        partial void PrepareOpenaiCompletions2Request(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xiApiKey,
            global::DeepInfra.OpenAICompletionsIn request);
        partial void ProcessOpenaiCompletions2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenaiCompletions2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOpenaiCompletions2Arguments(
            ...
            PrepareOpenaiCompletions2Request(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessOpenaiCompletions2Response(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessOpenaiCompletions2ResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
