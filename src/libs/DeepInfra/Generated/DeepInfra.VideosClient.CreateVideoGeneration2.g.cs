...
namespace DeepInfra
{
    public partial class VideosClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_CreateVideoGeneration2SecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_CreateVideoGeneration2SecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_CreateVideoGeneration2SecurityRequirement0,
            };
        partial void PrepareCreateVideoGeneration2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xiApiKey,
            ref string? xApiKey,
            global::DeepInfra.VideoGenerationIn request);
        partial void PrepareCreateVideoGeneration2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xiApiKey,
            string? xApiKey,
            global::DeepInfra.VideoGenerationIn request);
        partial void ProcessCreateVideoGeneration2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVideoGeneration2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.VideoGenerationOut> CreateVideoGeneration2Async(
        ...
        {
            var __response = await CreateVideoGeneration2AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.VideoGenerationOut>> CreateVideoGeneration2AsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVideoGeneration2Arguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVideoGeneration2SecurityRequirements,
                operationName: "CreateVideoGeneration2Async");
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVideoGeneration2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateVideoGeneration2",
                                methodName: "CreateVideoGeneration2Async",
                                pathTemplate: "\"/v1/openai/videos\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVideoGeneration2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVideoGeneration2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.VideoGenerationOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.VideoGenerationOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.VideoGenerationOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.VideoGenerationOut> CreateVideoGeneration2Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepInfra.VideoGenerationIn
            {
                Model = model,
                Prompt = prompt,
            ...
            return await CreateVideoGeneration2Async(
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
                request: __request,
                requestOptions: requestOptions,
