...
namespace DeepInfra
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_GetSandboxSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_GetSandboxSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_GetSandboxSecurityRequirement0,
            };
        partial void PrepareGetSandboxArguments(
        ...
        partial void ProcessGetSandboxResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.SandboxOut> GetSandboxAsync(
            string sandboxId,
        ...
        {
            var __response = await GetSandboxAsResponseAsync(
                sandboxId: sandboxId,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.SandboxOut>> GetSandboxAsResponseAsync(
            string sandboxId,
            string? xiApiKey = default,
            string? xApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSandboxSecurityRequirements,
                operationName: "GetSandboxAsync");
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSandboxResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.SandboxOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.SandboxOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.SandboxOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
