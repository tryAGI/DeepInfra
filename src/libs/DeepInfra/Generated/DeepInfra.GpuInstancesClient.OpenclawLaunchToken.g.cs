...
namespace DeepInfra
{
    public partial class GpuInstancesClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_OpenclawLaunchTokenSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_OpenclawLaunchTokenSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_OpenclawLaunchTokenSecurityRequirement0,
            };
        partial void PrepareOpenclawLaunchTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string instanceId,
            ref string? xiApiKey);
        partial void PrepareOpenclawLaunchTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string instanceId,
            string? xiApiKey);
        partial void ProcessOpenclawLaunchTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenclawLaunchTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.OpenClawLaunchTokenOut> OpenclawLaunchTokenAsync(
            string instanceId,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OpenclawLaunchTokenAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.OpenClawLaunchTokenOut>> OpenclawLaunchTokenAsResponseAsync(
            string instanceId,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOpenclawLaunchTokenArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OpenclawLaunchTokenSecurityRequirements,
                operationName: "OpenclawLaunchTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/v1/openclaw/{instanceId}/launch_token",
            ...
            if (xiApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOpenclawLaunchTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OpenclawLaunchToken",
                                methodName: "OpenclawLaunchTokenAsync",
                                pathTemplate: "$\"/v1/openclaw/{instanceId}/launch_token\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOpenclawLaunchTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOpenclawLaunchTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
