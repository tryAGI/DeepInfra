...
namespace DeepInfra
{
    public partial class DedicatedModelsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_DeployLlmStandardArgsSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_DeployLlmStandardArgsSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_DeployLlmStandardArgsSecurityRequirement0,
            };
        partial void PrepareDeployLlmStandardArgsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? engine,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareDeployLlmStandardArgsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? engine,
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessDeployLlmStandardArgsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeployLlmStandardArgsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DeployLlmStandardArgsAsync(
        ...
        {
            var __response = await DeployLlmStandardArgsAsResponseAsync(
                engine: engine,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> DeployLlmStandardArgsAsResponseAsync(
            string? engine = default,
            string? xiApiKey = default,
            string? xApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeployLlmStandardArgsArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeployLlmStandardArgsSecurityRequirements,
                operationName: "DeployLlmStandardArgsAsync");
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeployLlmStandardArgsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeployLlmStandardArgs",
                                methodName: "DeployLlmStandardArgsAsync",
                                pathTemplate: "\"/deploy/llm/standard_args\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeployLlmStandardArgsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeployLlmStandardArgsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
