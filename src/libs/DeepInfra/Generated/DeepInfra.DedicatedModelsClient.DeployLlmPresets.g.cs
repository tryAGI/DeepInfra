...
namespace DeepInfra
{
    public partial class DedicatedModelsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_DeployLlmPresetsSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_DeployLlmPresetsSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_DeployLlmPresetsSecurityRequirement0,
            };
        partial void PrepareDeployLlmPresetsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string hfRepoId,
            ref global::DeepInfra.DeployGPUs? gpu,
            ref string? engine,
            ref string? source,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareDeployLlmPresetsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessDeployLlmPresetsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeployLlmPresetsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::DeepInfra.PresetConfigOut>> DeployLlmPresetsAsync(
            string hfRepoId,
        ...
        {
            var __response = await DeployLlmPresetsAsResponseAsync(
                hfRepoId: hfRepoId,
                gpu: gpu,
                engine: engine,
                source: source,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::DeepInfra.PresetConfigOut>>> DeployLlmPresetsAsResponseAsync(
            string hfRepoId,
            global::DeepInfra.DeployGPUs? gpu = default,
            string? engine = default,
            string? source = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeployLlmPresetsArguments(
                httpClient: HttpClient,
                hfRepoId: ref hfRepoId,
                gpu: ref gpu,
                engine: ref engine,
                source: ref source,
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeployLlmPresetsSecurityRequirements,
                operationName: "DeployLlmPresetsAsync");
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeployLlmPresetsRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeployLlmPresets",
                                methodName: "DeployLlmPresetsAsync",
                                pathTemplate: "\"/deploy/llm/presets\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeployLlmPresetsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::DeepInfra.PresetConfigOut>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::DeepInfra.PresetConfigOut>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::DeepInfra.PresetConfigOut>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::DeepInfra.PresetConfigOut>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::DeepInfra.PresetConfigOut>), JsonSerializerContext).ConfigureAwait(false) ??
