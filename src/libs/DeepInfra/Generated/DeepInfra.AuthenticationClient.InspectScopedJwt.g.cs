...
namespace DeepInfra
{
    public partial class AuthenticationClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_InspectScopedJwtSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_InspectScopedJwtSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_InspectScopedJwtSecurityRequirement0,
            };
        partial void PrepareInspectScopedJwtArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string jwtoken,
            ref string? xiApiKey);
        partial void PrepareInspectScopedJwtRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string jwtoken,
            string? xiApiKey);
        partial void ProcessInspectScopedJwtResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInspectScopedJwtResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.InspectScopedJWTOut> InspectScopedJwtAsync(
            string jwtoken,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await InspectScopedJwtAsResponseAsync(
                jwtoken: jwtoken,
                xiApiKey: xiApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.InspectScopedJWTOut>> InspectScopedJwtAsResponseAsync(
            string jwtoken,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareInspectScopedJwtArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InspectScopedJwtSecurityRequirements,
                operationName: "InspectScopedJwtAsync");
            ...
            if (xiApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInspectScopedJwtRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InspectScopedJwt",
                                methodName: "InspectScopedJwtAsync",
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInspectScopedJwtResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.InspectScopedJWTOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.InspectScopedJWTOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.InspectScopedJWTOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
