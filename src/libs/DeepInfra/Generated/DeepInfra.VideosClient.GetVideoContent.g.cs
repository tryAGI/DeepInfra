...
namespace DeepInfra
{
    public partial class VideosClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_GetVideoContentSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_GetVideoContentSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_GetVideoContentSecurityRequirement0,
            };
        partial void PrepareGetVideoContentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string videoId,
            ref string? variant,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareGetVideoContentRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessGetVideoContentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVideoContentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetVideoContentAsync(
            string videoId,
        ...
        {
            var __response = await GetVideoContentAsResponseAsync(
                videoId: videoId,
                variant: variant,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> GetVideoContentAsResponseAsync(
            string videoId,
            string? variant = default,
            string? xiApiKey = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetVideoContentArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetVideoContentSecurityRequirements,
                operationName: "GetVideoContentAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetVideoContentAsync",
                                pathTemplate: "$\"/v1/videos/{videoId}/content\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetVideoContentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetVideoContentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
