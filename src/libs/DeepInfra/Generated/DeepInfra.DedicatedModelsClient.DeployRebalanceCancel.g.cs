...
namespace DeepInfra
{
    public partial class DedicatedModelsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_DeployRebalanceCancelSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_DeployRebalanceCancelSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_DeployRebalanceCancelSecurityRequirement0,
            };
        partial void PrepareDeployRebalanceCancelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string deployId,
            ref string? xiApiKey,
            ref string? xApiKey,
            global::DeepInfra.RebalanceCancelIn request);
        partial void PrepareDeployRebalanceCancelRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xApiKey,
            global::DeepInfra.RebalanceCancelIn request);
        partial void ProcessDeployRebalanceCancelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeployRebalanceCancelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.RebalanceCancelOut> DeployRebalanceCancelAsync(
            string deployId,
        ...
        {
            var __response = await DeployRebalanceCancelAsResponseAsync(
                deployId: deployId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.RebalanceCancelOut>> DeployRebalanceCancelAsResponseAsync(
            string deployId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDeployRebalanceCancelArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeployRebalanceCancelSecurityRequirements,
                operationName: "DeployRebalanceCancelAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/deploy/{deployId}/rebalance/cancel",
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeployRebalanceCancelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeployRebalanceCancel",
                                methodName: "DeployRebalanceCancelAsync",
                                pathTemplate: "$\"/deploy/{deployId}/rebalance/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeployRebalanceCancelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeployRebalanceCancelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.RebalanceCancelOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.RebalanceCancelOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.RebalanceCancelOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.RebalanceCancelOut> DeployRebalanceCancelAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepInfra.RebalanceCancelIn
            {
            };

            return await DeployRebalanceCancelAsync(
                deployId: deployId,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
                request: __request,
