...
namespace DeepInfra
{
    public partial class VideosClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_GetVideoContent2SecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_GetVideoContent2SecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_GetVideoContent2SecurityRequirement0,
            };
        partial void PrepareGetVideoContent2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string videoId,
            ref string? variant,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareGetVideoContent2Request(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessGetVideoContent2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVideoContent2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetVideoContent2Async(
            string videoId,
        ...
        {
            var __response = await GetVideoContent2AsResponseAsync(
                videoId: videoId,
                variant: variant,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> GetVideoContent2AsResponseAsync(
            string videoId,
            string? variant = default,
            string? xiApiKey = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetVideoContent2Arguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetVideoContent2SecurityRequirements,
                operationName: "GetVideoContent2Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/v1/openai/videos/{videoId}/content",
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetVideoContent2Request(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetVideoContent2",
                                methodName: "GetVideoContent2Async",
                                pathTemplate: "$\"/v1/openai/videos/{videoId}/content\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetVideoContent2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
