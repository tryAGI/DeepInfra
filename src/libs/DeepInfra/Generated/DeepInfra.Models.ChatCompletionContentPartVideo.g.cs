...
namespace DeepInfra
{
    ...
    public sealed partial class ChatCompletionContentPartVideo
    {
        ...
        /// <summary>
        /// Creates a new <see cref="ChatCompletionContentPartVideo"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static ChatCompletionContentPartVideo FromVideoUrl(global::DeepInfra.VideoURL videoUrl)
        {
            return new ChatCompletionContentPartVideo
            {
                VideoUrl = videoUrl,
            };
        }
