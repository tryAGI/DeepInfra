...
namespace DeepInfra
{
    public partial class BillingClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_AddCardCheckoutSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_AddCardCheckoutSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_AddCardCheckoutSecurityRequirement0,
            };
        partial void PrepareAddCardCheckoutArguments(
            global::System.Net.Http.HttpClient httpClient,
            object? session);
        partial void PrepareAddCardCheckoutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object? session);
        partial void ProcessAddCardCheckoutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddCardCheckoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Add Card Checkout<br/>
        /// Checkout page that saves a card, billing address included, so Add Funds<br/>
        /// can show it later.
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AddCardOut> AddCardCheckoutAsync(
            object? session = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AddCardCheckoutAsResponseAsync(
                session: session,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.AddCardOut>> AddCardCheckoutAsResponseAsync(
            object? session = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAddCardCheckoutArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddCardCheckoutSecurityRequirements,
                operationName: "AddCardCheckoutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: "/payment/payment-methods/setup",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AddCardCheckout",
                                methodName: "AddCardCheckoutAsync",
                                pathTemplate: "\"/payment/payment-methods/setup\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddCardCheckoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddCardCheckoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.AddCardOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.AddCardOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.AddCardOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
