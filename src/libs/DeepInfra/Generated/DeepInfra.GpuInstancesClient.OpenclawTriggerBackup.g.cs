...
namespace DeepInfra
{
    public partial class GpuInstancesClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_OpenclawTriggerBackupSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_OpenclawTriggerBackupSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_OpenclawTriggerBackupSecurityRequirement0,
            };
        partial void PrepareOpenclawTriggerBackupArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string instanceId,
            ref string? xiApiKey);
        partial void PrepareOpenclawTriggerBackupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string instanceId,
            string? xiApiKey);
        partial void ProcessOpenclawTriggerBackupResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenclawTriggerBackupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> OpenclawTriggerBackupAsync(
            string instanceId,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OpenclawTriggerBackupAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> OpenclawTriggerBackupAsResponseAsync(
            string instanceId,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOpenclawTriggerBackupArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OpenclawTriggerBackupSecurityRequirements,
                operationName: "OpenclawTriggerBackupAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/v1/openclaw/{instanceId}/backup",
            ...
            if (xiApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOpenclawTriggerBackupRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OpenclawTriggerBackup",
                                methodName: "OpenclawTriggerBackupAsync",
                                pathTemplate: "$\"/v1/openclaw/{instanceId}/backup\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOpenclawTriggerBackupResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOpenclawTriggerBackupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
