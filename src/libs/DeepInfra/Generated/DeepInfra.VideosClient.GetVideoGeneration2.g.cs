...
namespace DeepInfra
{
    public partial class VideosClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_GetVideoGeneration2SecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_GetVideoGeneration2SecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_GetVideoGeneration2SecurityRequirement0,
            };
        partial void PrepareGetVideoGeneration2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string videoId,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareGetVideoGeneration2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string videoId,
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessGetVideoGeneration2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVideoGeneration2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.VideoGenerationOut> GetVideoGeneration2Async(
            string videoId,
        ...
        {
            var __response = await GetVideoGeneration2AsResponseAsync(
                videoId: videoId,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.VideoGenerationOut>> GetVideoGeneration2AsResponseAsync(
            string videoId,
            string? xiApiKey = default,
            string? xApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetVideoGeneration2Arguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetVideoGeneration2SecurityRequirements,
                operationName: "GetVideoGeneration2Async");
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetVideoGeneration2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetVideoGeneration2",
                                methodName: "GetVideoGeneration2Async",
                                pathTemplate: "$\"/v1/openai/videos/{videoId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetVideoGeneration2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetVideoGeneration2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
