...
namespace DeepInfra
{
    ...
    {
        partial void PrepareCreateOpenaiBatch2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xiApiKey,
            global::DeepInfra.OpenAIBatchesIn request);
        partial void PrepareCreateOpenaiBatch2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xiApiKey,
            global::DeepInfra.OpenAIBatchesIn request);
        partial void ProcessCreateOpenaiBatch2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateOpenaiBatch2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.OpenAIBatch> CreateOpenaiBatch2Async(
            global::DeepInfra.OpenAIBatchesIn request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateOpenaiBatch2Arguments(
            ...
            PrepareCreateOpenaiBatch2Request(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreateOpenaiBatch2Response(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateOpenaiBatch2ResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateOpenaiBatch2Async(
                xiApiKey: xiApiKey,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
