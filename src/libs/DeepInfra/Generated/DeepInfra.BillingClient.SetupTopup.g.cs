...
namespace DeepInfra
{
    public partial class BillingClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_SetupTopupSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_SetupTopupSecurityRequirement0,
            };
        partial void PrepareSetupTopupArguments(
            global::System.Net.Http.HttpClient httpClient,
            object? session,
            global::DeepInfra.TopUpIn request);
        partial void PrepareSetupTopupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object? session,
            global::DeepInfra.TopUpIn request);
        partial void ProcessSetupTopupResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetupTopupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> SetupTopupAsync(
        ...
        {
            var __response = await SetupTopupAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> SetupTopupAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SetupTopupSecurityRequirements,
                operationName: "SetupTopupAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SetupTopup",
                                methodName: "SetupTopupAsync",
                                pathTemplate: "\"/payment/topup\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetupTopupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
