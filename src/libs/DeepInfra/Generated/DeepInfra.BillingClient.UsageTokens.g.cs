...
namespace DeepInfra
{
    public partial class BillingClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_UsageTokensSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_UsageTokensSecurityRequirement0,
            };
        partial void PrepareUsageTokensArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string from,
            ref string? to,
            object? session);
        partial void PrepareUsageTokensRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessUsageTokensResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.UsageOut> UsageTokensAsync(
            string from,
            string? to = default,
        ...
        {
            var __response = await UsageTokensAsResponseAsync(
                from: from,
                to: to,
                session: session,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.UsageOut>> UsageTokensAsResponseAsync(
            string from,
            string? to = default,
            object? session = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UsageTokensSecurityRequirements,
                operationName: "UsageTokensAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UsageTokens",
                                methodName: "UsageTokensAsync",
                                pathTemplate: "\"/payment/usage/tokens\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUsageTokensResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
