...
namespace DeepInfra
{
    ...
    {
        partial void PrepareOpenaiAudioSpeech2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xDeepinfraSource,
            ref string? xiApiKey,
            global::DeepInfra.OpenAITextToSpeechIn request);
        partial void PrepareOpenaiAudioSpeech2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xDeepinfraSource,
            string? xiApiKey,
            global::DeepInfra.OpenAITextToSpeechIn request);
        partial void ProcessOpenaiAudioSpeech2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenaiAudioSpeech2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> OpenaiAudioSpeech2Async(
            global::DeepInfra.OpenAITextToSpeechIn request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOpenaiAudioSpeech2Arguments(
            ...
            PrepareOpenaiAudioSpeech2Request(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessOpenaiAudioSpeech2Response(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessOpenaiAudioSpeech2ResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await OpenaiAudioSpeech2Async(
                xDeepinfraSource: xDeepinfraSource,
                xiApiKey: xiApiKey,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
