...
namespace DeepInfra
{
    public partial class GpuRentalsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_RentGpuAvailabilitySecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_RentGpuAvailabilitySecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_RentGpuAvailabilitySecurityRequirement0,
            };
        partial void PrepareRentGpuAvailabilityArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? source,
            ref string? baseModel,
            ref string? xiApiKey);
        partial void PrepareRentGpuAvailabilityRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? source,
            string? baseModel,
            string? xiApiKey);
        partial void ProcessRentGpuAvailabilityResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRentGpuAvailabilityResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.DeployGPUAvailability> RentGpuAvailabilityAsync(
        ...
        {
            var __response = await RentGpuAvailabilityAsResponseAsync(
                source: source,
                baseModel: baseModel,
                xiApiKey: xiApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.DeployGPUAvailability>> RentGpuAvailabilityAsResponseAsync(
            string? source = default,
            string? baseModel = default,
            string? xiApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRentGpuAvailabilityArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RentGpuAvailabilitySecurityRequirements,
                operationName: "RentGpuAvailabilityAsync");
            ...
            if (xiApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRentGpuAvailabilityRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RentGpuAvailability",
                                methodName: "RentGpuAvailabilityAsync",
                                pathTemplate: "\"/v1/containers/gpu_availability\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRentGpuAvailabilityResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRentGpuAvailabilityResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.DeployGPUAvailability.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.DeployGPUAvailability>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.DeployGPUAvailability.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
