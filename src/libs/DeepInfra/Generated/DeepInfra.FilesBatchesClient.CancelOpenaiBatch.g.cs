...
namespace DeepInfra
{
    public partial class FilesBatchesClient
    {


        private static readonly global::DeepInfra.EndPointSecurityRequirement s_CancelOpenaiBatchSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_CancelOpenaiBatchSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_CancelOpenaiBatchSecurityRequirement0,
            };
        partial void PrepareCancelOpenaiBatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string batchId,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareCancelOpenaiBatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string batchId,
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessCancelOpenaiBatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelOpenaiBatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.OpenAIBatchesOut> CancelOpenaiBatchAsync(
            string batchId,
        ...
        {
            var __response = await CancelOpenaiBatchAsResponseAsync(
                batchId: batchId,
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.OpenAIBatchesOut>> CancelOpenaiBatchAsResponseAsync(
            string batchId,
            string? xiApiKey = default,
            string? xApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelOpenaiBatchArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CancelOpenaiBatchSecurityRequirements,
                operationName: "CancelOpenaiBatchAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CancelOpenaiBatchAsync",
                                pathTemplate: "$\"/v1/batches/{batchId}/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelOpenaiBatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelOpenaiBatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.OpenAIBatchesOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.OpenAIBatchesOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.OpenAIBatchesOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
