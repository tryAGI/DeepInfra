...
namespace DeepInfra
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_UpdateInstanceVersionSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_UpdateInstanceVersionSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_UpdateInstanceVersionSecurityRequirement0,
            };
        partial void PrepareUpdateInstanceVersionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string instanceId,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareUpdateInstanceVersionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string instanceId,
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessUpdateInstanceVersionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateInstanceVersionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateInstanceVersionAsync(
            string instanceId,
        ...
        {
            var __response = await UpdateInstanceVersionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<string>> UpdateInstanceVersionAsResponseAsync(
            string instanceId,
            string? xiApiKey = default,
            string? xApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateInstanceVersionArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateInstanceVersionSecurityRequirements,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/v1/agents/{instanceId}/update",
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateInstanceVersionRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateInstanceVersionAsync",
                                pathTemplate: "$\"/v1/agents/{instanceId}/update\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateInstanceVersionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
