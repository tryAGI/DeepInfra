...
namespace DeepInfra
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_ListSandboxPlansSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_ListSandboxPlansSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_ListSandboxPlansSecurityRequirement0,
            };
        partial void PrepareListSandboxPlansArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareListSandboxPlansRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessListSandboxPlansResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListSandboxPlansResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List Sandbox Plans<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::DeepInfra.SandboxPlanOut>> ListSandboxPlansAsync(
            string? xiApiKey = default,
            string? xApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListSandboxPlansAsResponseAsync(
                xiApiKey: xiApiKey,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::DeepInfra.SandboxPlanOut>>> ListSandboxPlansAsResponseAsync(
            string? xiApiKey = default,
            string? xApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListSandboxPlansArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListSandboxPlansSecurityRequirements,
                operationName: "ListSandboxPlansAsync");
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListSandboxPlansRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListSandboxPlans",
                                methodName: "ListSandboxPlansAsync",
                                pathTemplate: "\"/v1/sandboxes/catalog\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListSandboxPlansResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListSandboxPlansResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::DeepInfra.SandboxPlanOut>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::DeepInfra.SandboxPlanOut>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::DeepInfra.SandboxPlanOut>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::DeepInfra.SandboxPlanOut>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::DeepInfra.SandboxPlanOut>), JsonSerializerContext).ConfigureAwait(false) ??
