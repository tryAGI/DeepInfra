...
namespace DeepInfra
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement s_CreateDashboardLaunchTokenSecurityRequirement0 =
        ...
        private static readonly global::DeepInfra.EndPointSecurityRequirement[] s_CreateDashboardLaunchTokenSecurityRequirements =
            new global::DeepInfra.EndPointSecurityRequirement[]
            {                s_CreateDashboardLaunchTokenSecurityRequirement0,
            };
        partial void PrepareCreateDashboardLaunchTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string instanceId,
            ref string? xiApiKey,
            ref string? xApiKey);
        partial void PrepareCreateDashboardLaunchTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string instanceId,
            string? xiApiKey,
            string? xApiKey);
        partial void ProcessCreateDashboardLaunchTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateDashboardLaunchTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Create Dashboard Launch Token<br/>
        ...
        /// auth flow (oc_auth cookie value = bearer token).<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::DeepInfra.OpenClawLaunchTokenOut> CreateDashboardLaunchTokenAsync(
            string instanceId,
        ...
        {
            var __response = await CreateDashboardLaunchTokenAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepInfra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.OpenClawLaunchTokenOut>> CreateDashboardLaunchTokenAsResponseAsync(
            string instanceId,
            string? xiApiKey = default,
            string? xApiKey = default,
            global::DeepInfra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDashboardLaunchTokenArguments(
            ...
            var __authorizations = global::DeepInfra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDashboardLaunchTokenSecurityRequirements,
                operationName: "CreateDashboardLaunchTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepInfra.PathBuilder(
                                path: $"/v1/agents/{instanceId}/launch_token",
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDashboardLaunchTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepInfra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateDashboardLaunchToken",
                                methodName: "CreateDashboardLaunchTokenAsync",
                                pathTemplate: "$\"/v1/agents/{instanceId}/launch_token\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDashboardLaunchTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepInfra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateDashboardLaunchTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepInfra.OpenClawLaunchTokenOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepInfra.AutoSDKHttpResponse<global::DeepInfra.OpenClawLaunchTokenOut>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepInfra.OpenClawLaunchTokenOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
