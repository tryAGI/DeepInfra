...
Tests in `src/tests/DeepInfra.IntegrationTests/Examples` are the single source of truth for both test coverage and documentation:
...
- Config: `autosdk.docs.json` points to `src/tests/DeepInfra.IntegrationTests/Examples`
